...
contract ExchangeV1 is Ownable {
    ...
    function exchange(
        ...
        validateBidRequest(sellToken, sellTokenId, buyToken, buyValue);
    ...
    function BuyRequest(address token, uint256 tokenId, uint256 amount) public {
    ...
    function validateBidRequest(address sellToken, uint256 tokenId, address buyToken, uint256 amount) internal {
        require(bidOrder[sellToken][tokenId][msg.sender][buyToken] == amount, "Amount is incorrect.");
    }
